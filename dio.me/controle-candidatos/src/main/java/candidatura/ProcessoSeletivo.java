...
public class ProcessoSeletivo {
    ...
    static void imprimirCandidatos(){
        ...
        System.out.println("Utilizando o for each para fazer a interação");
    ...
    static void selecaoCandidatos(){
        ...
        while(candidatosSelecionados < 5 && candidatoAtual < candidatos.length){
            ...
            System.out.printf("Candidato:" + candidato + " solicitou este valor de salário: R$ " + salarioPretendido + "\n");
    ...
    //método auxiliar para simular que o candidato atendeu
